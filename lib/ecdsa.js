...
var ECPublicKey = function (ec, publicKey) {
  this._ec = ec;
...
ECPublicKey.prototype.toAsn1 = function (options) {
  ...
  var aid = asn1.create(asn1.Class.UNIVERSAL, asn1.Type.SEQUENCE, true, [
    asn1.create(asn1.Class.UNIVERSAL, asn1.Type.OID, false, asn1.oidToDer(forge.oids['ecPublicKey']).getBytes()),
    asn1.create(asn1.Class.UNIVERSAL, asn1.Type.OID, false, asn1.oidToDer(curveOID).getBytes()),
  ]);
  obj.value.push(aid);
  obj.value.push(asn1.create(asn1.Class.UNIVERSAL, asn1.Type.BITSTRING, false, '\0' + this.getBytes()));
  return obj;
};
...
var ECPrivateKey = function (ec, privateKey) {
  this._ec = ec;
...
ECPrivateKey.prototype.toAsn1 = function (options) {
  ...
  return asn1.create(asn1.Class.UNIVERSAL, asn1.Type.SEQUENCE, true, [
    ...
    asn1.create(asn1.Class.UNIVERSAL, asn1.Type.OCTETSTRING, false, this.getBytes()),
