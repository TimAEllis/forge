  ...
  msg = {
    ...
    addSigner: function (signer) {
      ...
      switch (digestAlgorithm) {
        ...
        case forge.pki.oids['ecdsa-with-SHA384']:
          break;
        default:
...
function _attributeToAsn1(attr) {
  ...
  if (attr.type === forge.pki.oids.contentType) {
  ...
  } else if (attr.type === forge.pki.oids.signingTime || attr.type === forge.pki.oids.contentTimeStamp) {
  ...
  } else if (attr.type === forge.pki.oids.essSigningCertificateV2) {
    // SigningCertificateV2 ::=  SEQUENCE {
    // certs        SEQUENCE OF ESSCertIDv2,
    // policies     SEQUENCE OF PolicyInformation OPTIONAL

    value = asn1.create(asn1.Class.UNIVERSAL, asn1.Type.SEQUENCE, true, [attr.value]);
  } else if (attr.type === forge.pki.oids.CMSAlgorithmProtection) {
    ...
    value = attr.value;
  } else if (attr.type === forge.pki.oids.revocationInfoArchival) {
